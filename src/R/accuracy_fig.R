...
accuracy_all <- stats_1 %>%
  ggplot(aes(y = freq_predict_wt, 
             x = fct_rev(fct_relevel(group, "CNN", "BERT", "ESM1b")), 
             fill = fct_relevel(group, "CNN", "BERT", "ESM1b"), 
             color = fct_relevel(group, "CNN", "BERT", "ESM1b"))) +
...
abcd
ggsave(filename = "./analysis/figures/accuracy_fig2.png", plot = abcd, width = 9, height = 7)
